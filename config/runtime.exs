...
#
#     PHX_SERVER=true bin/phoenix_vault start
#
...
config :phoenix_vault,
       ...
       System.get_env("ARCHIVE_DIR") ||
         raise("""
         environment variable ARCHIVE_DIR is missing.
         """)
...
if config_env() == :prod do
  ...
  config :phoenix_vault, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :phoenix_vault, PhoenixVault.Mailer,
